...
@traceable(run_type="tool", name="AgentB_WebSearch")
...
@traceable(run_type="tool", name="AgentB_GCPDocs")
...
@traceable(run_type="tool", name="AgentB_ExecutePython")
...
@traceable(run_type="tool", name="AgentB_GCSWrite")
...
@traceable(run_type="tool", name="AgentB_RecordCitations")
